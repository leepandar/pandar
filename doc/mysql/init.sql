...
-- ----------------------------
BEGIN;
INSERT INTO `sys_notice` VALUES (16, 1849729827784355840, '多租户管理系统1.0.0版本发布', 1, '基于SpringBoot3+Vue3的前后端分离的单体多租户脚手架，具备一些常用的基础功能。\n', '1851164126132932608', b'1', NULL, 1, b'0', NULL, 1677964029214371840, 0, '2024-10-25 16:28:51.919183', 1, 0, '2024-10-25 16:28:52.000000', 0, '2024-10-29 15:28:42.000000', b'0', 12);
COMMIT;
...
CREATE TABLE `sys_perms` (
                             ...
                             `version` int DEFAULT '0' COMMENT '版本号',
                             PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=90 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='权限表';

-- ----------------------------
-- Records of sys_perms
-- ----------------------------
BEGIN;
INSERT INTO `sys_perms` VALUES (6, 1669336412647133184, NULL, '系统管理', 0, 20, NULL, 'IconSettings', 'M', NULL, b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 4);
INSERT INTO `sys_perms` VALUES (7, 1669338708936298496, NULL, '用户管理', 1669336412647133184, 10, '/sys/user/mgt', 'IconUser', 'M', '/sys/user/UserMgt.vue', b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 6);
INSERT INTO `sys_perms` VALUES (8, 1669339147886989312, NULL, '菜单权限', 1979506374983032832, 30, '/sys/perm/mgt', 'IconNav', 'M', '/sys/perm/PermMgt.vue', b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-18 19:26:57.000000', b'0', 12);
INSERT INTO `sys_perms` VALUES (9, 1669339375922909184, NULL, '字典管理', 1669336412647133184, 50, '/sys/dict/mgt', 'IconDice', 'M', '/sys/dict/DictMgt.vue', b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 6);
INSERT INTO `sys_perms` VALUES (15, 1673167646340120576, NULL, '角色管理', 1979506374983032832, 20, '/sys/role/mgt', 'IconUserGroup', 'M', '/sys/role/RoleMgt.vue', b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-18 19:28:54.000000', b'0', 10);
INSERT INTO `sys_perms` VALUES (16, 1673524365792530432, NULL, '部门管理', 1669336412647133184, 40, '/sys/dept/mgt', 'IconMindMapping', 'M', '/sys/dept/DeptMgt.vue', b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 5);
INSERT INTO `sys_perms` VALUES (17, 1673524591861321728, NULL, '岗位管理', 1669336412647133184, 45, '/sys/post/mgt', 'IconBulb', 'M', '/sys/post/PostMgt.vue', b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 5);
...
INSERT INTO `sys_perms` VALUES (20, 1676499330464649216, NULL, '租户维护', 0, 60, NULL, 'IconCloud', 'M', NULL, b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-18 19:29:26.000000', b'0', 6);
INSERT INTO `sys_perms` VALUES (21, 1676499559247155200, NULL, '套餐管理', 1676499330464649216, 10, '/sys/tenantPackage/mgt', 'IconCommon', 'M', '/sys/tenantPackage/TenantPackageMgt.vue', b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 5);
INSERT INTO `sys_perms` VALUES (22, 1676501907755405312, NULL, '租户管理', 1676499330464649216, 20, '/sys/tenant/mgt', 'IconRelation', 'M', '/sys/tenant/TenantMgt.vue', b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 4);
INSERT INTO `sys_perms` VALUES (28, 1680749851857862656, '', '接口文档', 1669336412647133184, 100, '/sys/swagger', 'IconBook', 'M', '/sys/system/Swagger.vue', b'0', b'1', '将swagger页面嵌入到系统', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 4);
INSERT INTO `sys_perms` VALUES (29, 1681273378598850560, NULL, '系统公告', 1669336412647133184, 60, '/sys/notice/mgt', 'IconSubscribe', 'M', '/sys/notice/NoticeMgt.vue', b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 2);
INSERT INTO `sys_perms` VALUES (30, 1683285343149096960, NULL, '文件管理', 1669336412647133184, 55, '/sys/file/mgt', 'IconFile', 'M', '/sys/file/FileMgt.vue', b'0', b'1', '', 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 3);
...
INSERT INTO `sys_perms` VALUES (73, 1833687152849211392, '', '参数配置', 1669336412647133184, 70, '/sys/config/mgt', 'IconSettings', 'M', '/sys/config/ConfigMgt.vue', b'0', b'1', NULL, 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 5);
...
INSERT INTO `sys_perms` VALUES (78, 1843898617245937664, NULL, '存储管理', 1669336412647133184, 58, '/sys/storage/mgt', 'IconStorage', 'M', '/sys/storage/StorageMgt.vue', b'0', b'1', NULL, 1, 0, '2025-10-17 14:23:05.000000', 0, '2025-10-17 14:23:05.000000', b'0', 2);
...
INSERT INTO `sys_perms` VALUES (89, 1979506374983032832, NULL, '权限管理', 0, 30, NULL, 'IconSafe', 'M', NULL, b'0', b'1', NULL, 1, 0, '2025-10-18 19:14:31.000000', 0, '2025-10-18 19:28:35.000000', b'0', 2);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` VALUES (101, 1671337763855073280, '系统管理员', 'systesys_admin', 0, 1, NULL, 0, 0, '2023-06-21 10:02:29.514290', 0, '2025-10-18 19:26:37.000000', b'0', 45);
...
CREATE TABLE `sys_role_perm` (
                                 ...
                                 KEY `role_id_idx` (`role_id`) USING BTREE COMMENT '角色ID索引'
) ENGINE=InnoDB AUTO_INCREMENT=2163 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='角色与权限关联表 1角色-N权限';
...
INSERT INTO `sys_role_perm` VALUES (2098, 1671337763855073280, 1685985572129398784);
INSERT INTO `sys_role_perm` VALUES (2099, 1671337763855073280, 1685985875515990016);
INSERT INTO `sys_role_perm` VALUES (2100, 1671337763855073280, 1685985977349496832);
INSERT INTO `sys_role_perm` VALUES (2101, 1671337763855073280, 1685986276453703680);
INSERT INTO `sys_role_perm` VALUES (2102, 1671337763855073280, 1669338708936298496);
INSERT INTO `sys_role_perm` VALUES (2103, 1671337763855073280, 1685986566443687936);
INSERT INTO `sys_role_perm` VALUES (2104, 1671337763855073280, 1685986702834065408);
INSERT INTO `sys_role_perm` VALUES (2105, 1671337763855073280, 1685986806387236864);
INSERT INTO `sys_role_perm` VALUES (2106, 1671337763855073280, 1685986887102423040);
INSERT INTO `sys_role_perm` VALUES (2107, 1671337763855073280, 1673167646340120576);
INSERT INTO `sys_role_perm` VALUES (2108, 1671337763855073280, 1685987612687654912);
INSERT INTO `sys_role_perm` VALUES (2109, 1671337763855073280, 1685987708229705728);
INSERT INTO `sys_role_perm` VALUES (2110, 1671337763855073280, 1685988419789185024);
INSERT INTO `sys_role_perm` VALUES (2111, 1671337763855073280, 1685988623951126528);
INSERT INTO `sys_role_perm` VALUES (2112, 1671337763855073280, 1669339147886989312);
INSERT INTO `sys_role_perm` VALUES (2113, 1671337763855073280, 1685996318275985408);
INSERT INTO `sys_role_perm` VALUES (2114, 1671337763855073280, 1685996426530971648);
INSERT INTO `sys_role_perm` VALUES (2115, 1671337763855073280, 1685996547448561664);
INSERT INTO `sys_role_perm` VALUES (2116, 1671337763855073280, 1685996623386435584);
INSERT INTO `sys_role_perm` VALUES (2117, 1671337763855073280, 1673524365792530432);
INSERT INTO `sys_role_perm` VALUES (2118, 1671337763855073280, 1685996875623489536);
INSERT INTO `sys_role_perm` VALUES (2119, 1671337763855073280, 1685997536914235392);
INSERT INTO `sys_role_perm` VALUES (2120, 1671337763855073280, 1685997640341577728);
INSERT INTO `sys_role_perm` VALUES (2121, 1671337763855073280, 1685997732956004352);
INSERT INTO `sys_role_perm` VALUES (2122, 1671337763855073280, 1673524591861321728);
INSERT INTO `sys_role_perm` VALUES (2123, 1671337763855073280, 1685998041879076864);
INSERT INTO `sys_role_perm` VALUES (2124, 1671337763855073280, 1685998171407572992);
INSERT INTO `sys_role_perm` VALUES (2125, 1671337763855073280, 1685998244715618304);
INSERT INTO `sys_role_perm` VALUES (2126, 1671337763855073280, 1685998340425441280);
INSERT INTO `sys_role_perm` VALUES (2127, 1671337763855073280, 1669339375922909184);
INSERT INTO `sys_role_perm` VALUES (2128, 1671337763855073280, 1846813160695615488);
INSERT INTO `sys_role_perm` VALUES (2129, 1671337763855073280, 1846813266043949056);
INSERT INTO `sys_role_perm` VALUES (2130, 1671337763855073280, 1846813437867806720);
INSERT INTO `sys_role_perm` VALUES (2131, 1671337763855073280, 1846813517064654848);
INSERT INTO `sys_role_perm` VALUES (2132, 1671337763855073280, 1683285343149096960);
INSERT INTO `sys_role_perm` VALUES (2133, 1671337763855073280, 1843900739123359744);
INSERT INTO `sys_role_perm` VALUES (2134, 1671337763855073280, 1843900820899704832);
INSERT INTO `sys_role_perm` VALUES (2135, 1671337763855073280, 1843900873001349120);
INSERT INTO `sys_role_perm` VALUES (2136, 1671337763855073280, 1843900946787545088);
INSERT INTO `sys_role_perm` VALUES (2137, 1671337763855073280, 1843898617245937664);
INSERT INTO `sys_role_perm` VALUES (2138, 1671337763855073280, 1686002657173757952);
INSERT INTO `sys_role_perm` VALUES (2139, 1671337763855073280, 1686002750660599808);
INSERT INTO `sys_role_perm` VALUES (2140, 1671337763855073280, 1686002863185387520);
INSERT INTO `sys_role_perm` VALUES (2141, 1671337763855073280, 1686002975089418240);
INSERT INTO `sys_role_perm` VALUES (2142, 1671337763855073280, 1676499559247155200);
INSERT INTO `sys_role_perm` VALUES (2143, 1671337763855073280, 1686004858881368064);
INSERT INTO `sys_role_perm` VALUES (2144, 1671337763855073280, 1686005292303966208);
INSERT INTO `sys_role_perm` VALUES (2145, 1671337763855073280, 1686005483111243776);
INSERT INTO `sys_role_perm` VALUES (2146, 1671337763855073280, 1686005567790047232);
INSERT INTO `sys_role_perm` VALUES (2147, 1671337763855073280, 1676501907755405312);
INSERT INTO `sys_role_perm` VALUES (2148, 1671337763855073280, 1676499330464649216);
INSERT INTO `sys_role_perm` VALUES (2149, 1671337763855073280, 1686001693859569664);
INSERT INTO `sys_role_perm` VALUES (2150, 1671337763855073280, 1686001770980237312);
INSERT INTO `sys_role_perm` VALUES (2151, 1671337763855073280, 1686002193703165952);
INSERT INTO `sys_role_perm` VALUES (2152, 1671337763855073280, 1686002291338174464);
INSERT INTO `sys_role_perm` VALUES (2153, 1671337763855073280, 1681273378598850560);
INSERT INTO `sys_role_perm` VALUES (2154, 1671337763855073280, 1833688664656728064);
INSERT INTO `sys_role_perm` VALUES (2155, 1671337763855073280, 1833688838682595328);
INSERT INTO `sys_role_perm` VALUES (2156, 1671337763855073280, 1833688910472302592);
INSERT INTO `sys_role_perm` VALUES (2157, 1671337763855073280, 1833688972682219520);
INSERT INTO `sys_role_perm` VALUES (2158, 1671337763855073280, 1833687152849211392);
INSERT INTO `sys_role_perm` VALUES (2159, 1671337763855073280, 1846819585257852928);
INSERT INTO `sys_role_perm` VALUES (2160, 1671337763855073280, 1680749851857862656);
INSERT INTO `sys_role_perm` VALUES (2161, 1671337763855073280, 1669336412647133184);
INSERT INTO `sys_role_perm` VALUES (2162, 1671337763855073280, 1979506374983032832);
COMMIT;
