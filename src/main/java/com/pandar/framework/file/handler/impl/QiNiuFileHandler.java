package com.pandar.framework.file.handler.impl;
...
import com.pandar.framework.file.FileManager;
import com.pandar.framework.file.entity.QiNiuFile;
import com.pandar.framework.file.handler.FileHandler;
import com.pandar.modules.sys.domain.entity.File;
import com.pandar.modules.sys.domain.entity.Storage;
import com.pandar.modules.sys.mapper.FileMapper;
import com.pandar.modules.sys.mapper.StorageMapper;
import com.pandar.common.utils.TenantUtil;
import com.pandar.common.utils.TextUtil;
import com.pandar.common.utils.UnqIdUtil;
import com.pandar.common.utils.ValidateUtil;
...
public class QiNiuFileHandler implements FileHandler {
    ...
    public String valid(String storageConfig) {
        QiNiuFile qiNiuFileEntity = JSONUtil.toBean(storageConfig, QiNiuFile.class);
    ...
    public File uploadFile(MultipartFile multipartFile, Integer fileSource, Storage storage) {
        ...
        //文件信息
        QiNiuFile qnConfig = JSONUtil.toBean(storage.getStorageConfig(), QiNiuFile.class);
