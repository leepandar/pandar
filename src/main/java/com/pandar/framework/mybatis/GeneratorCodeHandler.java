package com.pandar.framework.mybatis;
...
public class GeneratorCodeHandler {
    ...
    public static void main(String[] args) {
        ...
        //设置生成 entity 包名
        globalConfig.setEntityPackage("com.pandar.modules.sys.domain.entity");
        //自动填充
        ...
        //mapper包
        globalConfig.setMapperPackage("com.pandar.modules.sys.mapper");
        //生成mapper xml文件
